...
@section('body')
    ...
    <div class="col">
        <div class="card">
            <div class="card-body">
                <h3 class="mb-4 text-center text-success display-6">Agent To Bank Transfer</h3>
                <h4 class="text-center text-success">{{session('message')}}</h4>
                <form action="{{route('agentTransfer.create')}}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <div class="form-group row mb-4">
                        <label for="horizontal-mobile-input" class="col-sm-3 col-form-label">Bank Mobile Number</label>
                        <div class="col-sm-9">
